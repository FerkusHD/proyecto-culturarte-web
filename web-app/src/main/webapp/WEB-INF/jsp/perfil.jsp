                ...
                <body class="bg-light">
                    ...
                    <div class="container-fluid py-4">
                        <div class="row">
                                ...
                                <div class="card shadow-sm p-4">
                                    <div class="text-center">
                                        ...
                                        <c:choose>
                                            <c:when test="${not empty perfilVisitado.imagen}">
                                                <img src="${pageContext.request.contextPath}/${perfilVisitado.imagen}"
                                                    class="rounded-circle mb-3" alt="Imagen de perfil"
                                        ...
                                        <span class="badge bg-secondary text-uppercase"
                                            style="font-size: 0.7em;">${perfilVisitado.tipo}</span>
                                        <p class="text-muted mb-1">${perfilVisitado.nombre} ${perfilVisitado.apellido}
                                        </p>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${loSigo}">
                                                <form action="${pageContext.request.contextPath}/usuarios/dejarDeSeguir"
                                                    method="post" class="d-inline-block mt-2">
                                                    <input type="hidden" name="nickSeguido"
                                                        value="${perfilVisitado.nickname}" />
                                            ...
                                            <c:otherwise>
                                                <form action="${pageContext.request.contextPath}/usuarios/seguir"
                                                    method="post" class="d-inline-block mt-2">
                                                    <input type="hidden" name="nickSeguido"
                                                        value="${perfilVisitado.nickname}" />
                                                    <input type="hidden" name="${_csrf.parameterName}"
                                    ...
                                    <div class="d-flex justify-content-center gap-3 mt-2">
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            data-bs-toggle="modal" data-bs-target="#seguidoresModal">
                                            Seguidores <span
                                                class="badge bg-primary">${perfilVisitado.usuariosSeguidores.size()}</span>
                                        </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            data-bs-toggle="modal" data-bs-target="#seguidosModal">
                                            Seguidos <span
                                                class="badge bg-primary">${perfilVisitado.usuariosSeguidos.size()}</span>
                                        </button>
                                    </div>
                            ...
                            <!-- Modal Seguidores -->
                            <div class="modal fade" id="seguidoresModal" tabindex="-1"
                                aria-labelledby="seguidoresModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <c:choose>
                                                <c:when test="${not empty perfilVisitado.usuariosSeguidores}">
                                                    <ul class="list-group">
                                                        <c:forEach var="seguidor"
                                                            items="${perfilVisitado.usuariosSeguidores}">
                                                            <li
                                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                                <a href="${pageContext.request.contextPath}/usuarios/${seguidor.nickname}"
                                                                    class="text-decoration-none text-dark d-flex align-items-center">
                                                                    <i
                                                                        class="bi bi-person-circle me-2 text-primary"></i>
                                                                    <span
                                                                        class="fw-semibold">${seguidor.nickname}</span>
                                                                </a>

                                                                <!-- Botón de seguir -->
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${usuarioLogueado.tipo eq 'visitante' || usuarioLogueado.nickname eq seguidor.nickname}">
                                                                        <button type="button"
                                                                    ...
                                                                    <c:when
                                                                        test="${usuarioLogueado.buscarUsuarioSeguido(seguidor.nickname)}">
                                                                        <form
                                                                            action="${pageContext.request.contextPath}/usuarios/dejarDeSeguir"
                                                                            method="post" class="d-inline-block mt-2">
                                                                            <input type="hidden" name="nickSeguido"
                                                                                value="${seguidor.nickname}" />
                                                                            <input type="hidden"
                            ...
                            <!-- Modal Seguidos -->
                            <div class="modal fade" id="seguidosModal" tabindex="-1"
                                aria-labelledby="seguidosModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <c:choose>
                                                <c:when test="${not empty perfilVisitado.usuariosSeguidos}">
                                                    <ul class="list-group">
                                                        <c:forEach var="seguido"
                                                            items="${perfilVisitado.usuariosSeguidos}">
                                                            <li
                                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                                <a href="${pageContext.request.contextPath}/usuarios/${seguido.nickname}"
                                                                    class="text-decoration-none text-dark d-flex align-items-center">
                                                                    <i
                                                                        class="bi bi-person-circle me-2 text-primary"></i>
                                                                ...
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${usuarioLogueado.tipo eq 'visitante' || usuarioLogueado.nickname eq seguido.nickname}">
                                                                        <button type="button"
                                                                            class="btn btn-secondary btn-sm mt-2"
                                                                            disabled>
                                                                            <i class="bi bi-person-plus"></i> Seguir
                                                                    ...
                                                                    <c:when
                                                                        test="${usuarioLogueado.buscarUsuarioSeguido(seguido.nickname)}">
                                                                        <form
                                                                            action="${pageContext.request.contextPath}/usuarios/dejarDeSeguir"
                                                                            method="post" class="d-inline-block mt-2">
                                                                            <input type="hidden" name="nickSeguido"
                                                                                value="${seguido.nickname}" />
                                                                            <input type="hidden"
                                                                                name="${_csrf.parameterName}"
                                                                                value="${_csrf.token}" />
                                                                            <button type="submit"
                                ...
                                <div class="card shadow-sm mb-4">
                                    <div class="card-header bg-white">
                                        <ul class="nav nav-tabs card-header-tabs" id="perfilTabs" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="propuestasFav-tab"
                                                    data-bs-toggle="tab" data-bs-target="#propuestasFav"
                                                    type="button">Propuestas Favoritas</button>
                                            </li>
                                            <!-- Tabs de proponente -->
                                            <c:if test="${not empty proponente}">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="info-tab" data-bs-toggle="tab"
                                                        data-bs-target="#info" type="button">Información</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="publicadas-tab" data-bs-toggle="tab"
                                                        data-bs-target="#propuestasCreadas" type="button">Propuestas
                                                        Publicadas</button>
                                                </li>
                                                <c:if test="${esMiPropioPerfil}">
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="ingresadas-tab"
                                                            data-bs-toggle="tab" data-bs-target="#propuestasIngresadas"
                                                            type="button">Propuestas Ingresadas</button>
                                                    </li>
                                                </c:if>
                                            </c:if>
                                            <!-- Tabs de colaborador -->
                                            <c:if test="${not empty colaborador}">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="colaborador-tab" data-bs-toggle="tab"
                                                        data-bs-target="#colaboraciones"
                                                        type="button">Colaboraciones</button>
                                                </li>
                                            </c:if>
                                    ...
                                    <div class="tab-content p-3" id="perfilTabsContent" style="min-height: 400px;">
                                        ...
                                        <div class="tab-pane fade show active" id="propuestasFav" role="tabpanel">
                                            ...
                                            <c:choose>
                                                <c:when
                                                    test="${not empty perfilVisitado.propuestasSeguidas && perfilVisitado.propuestasSeguidas.size() > 0}">
                                                    <div class="row g-3">
                                                        <c:forEach var="propuesta"
                                                            items="${perfilVisitado.propuestasSeguidas}">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="card-body">
                                                                        <h6 class="card-title fw-bold mb-2"
                                                                            style="font-size: 14px;">${propuesta.titulo}
                                                                            - ${propuesta.estadoActual}</h6>
                                                                        <p class="card-text text-muted mb-0"
                                                                            style="font-size: 12px;">
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${fn:length(propuesta.descripcion) > 120}">
                                                                                    ${propuesta.descripcion.substring(0,
                                                                                    120)}...
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="${pageContext.request.contextPath}/propuestas/${propuesta.titulo}"
                                                                            class="btn btn-sm btn-primary w-100">Ver
                                                                            Propuesta</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <c:if test="${not empty proponente}">
                                            ...
                                            <div class="tab-pane fade" id="propuestasCreadas" role="tabpanel">
                                                ...
                                                <c:choose>
                                                    <c:when
                                                        test="${not empty proponente.propuestas && proponente.propuestas.size() > 0}">
                                                        <div class="row g-3">
                                                                ...
                                                                <c:if test="${propuesta.estadoActual ne 'INGRESADA'}">
                                                                    <div class="col-md-6 col-lg-4">
                                                                        <div
                                                                            ...
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${not empty propuesta.imagen}">
                                                                                    <img src="${pageContext.request.contextPath}/${propuesta.imagen}"
                                                                                        ...>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                ...
                                                <div class="tab-pane fade" id="propuestasIngresadas" role="tabpanel">
                                                    ...
                                                    <c:choose>
                                                        <c:when
                                                            ...
                                                            <div class="row g-3">
                                                                <c:forEach var="propuesta"
                                                                    items="${proponente.propuestas}">
                                                                    <c:if
                                                                        test="${propuesta.estadoActual eq 'INGRESADA'}">
                                                                        <div class="col-md-6 col-lg-4">
                                                                            <div
                                                                                class="card h-100 shadow-sm border-0 rounded-3 overflow-hidden hover-shadow">
                                                                                <!-- Imagen de la propuesta -->
                                                        ...
                                                        <c:otherwise>
                                                            <div class="text-center py-5">
                                                                <i class="bi bi-people fs-1 text-muted mb-3"></i>
                                                                <h5 class="text-muted">Aún no hay propuestas publicadas
                                                                </h5>
                                                            </div>
                                                        </c:otherwise>
                                                    </c:choose>
                                        ...
                                        <c:if test="${not empty colaborador}">
                                            <div class="tab-pane fade" id="colaboraciones" role="tabpanel">
                                                ...
                                                <c:choose>
                                                    <c:when
                                                        test="${not empty colaborador.colaboraciones && colaborador.colaboraciones.size() > 0}">
                                                        <div class="row g-3">
                                                            <c:forEach var="colaboracion"
                                                                items="${colaborador.colaboraciones}">
                                                                <c:if
                                                                    test="${colaboracion.propuesta.estadoActual ne 'INGRESADA'}">
                                                                    <div class="col-md-6 col-lg-4">
                                                                        <div
                                                                            class="card h-100 shadow-sm border-0 rounded-3 overflow-hidden hover-shadow">
                                                                            <!-- Imagen de la propuesta -->
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${not empty colaboracion.propuesta.imagen}">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <h6 class="card-title fw-bold mb-2"
                                                                                    ...
                                                                                    ${colaboracion.propuesta.estadoActual}
                                                                                </h6>
                                                                                <p class="card-text text-muted mb-2"
                                                                                    style="font-size: 12px;">
                                                                                    <c:choose>
                                                                                        <c:when
                                                                                            test="${fn:length(colaboracion.propuesta.descripcion) > 120}">
                                                                                            ${colaboracion.propuesta.descripcion.substring(0,
                                                                                            120)}...
                                                                                        </c:when>
                                                                                        <c:otherwise>
                                                                                ...
                                                                                <c:if test="${esMiPropioPerfil}">
                                                                                    ...
                                                                                    <p class="card-text text-muted mb-0"
                                                                                        style="font-size: 12px;">
                                                                                        <strong>Fecha:
                                                                                        </strong>${colaboracion.fecha}
                                                                                    </p>
                                                                                    <p class="card-text text-muted mb-0"
                                                                                        style="font-size: 12px;">
                                                                                        <strong>Monto:
                                                                                        </strong>${colaboracion.monto}
                                                                                    </p>
                                                                                    <p class="card-text text-muted mb-0"
                                                                                        style="font-size: 12px;">
                                                                                        <strong>Tipo Retorno:
                                                                                        </strong>${colaboracion.tipoRetorno}
                                                                                    </p>
                                                                                </c:if>
                                                                            </div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-grid gap-2">
                                                                                    <a href="${pageContext.request.contextPath}/propuestas/${colaboracion.propuesta.titulo}"

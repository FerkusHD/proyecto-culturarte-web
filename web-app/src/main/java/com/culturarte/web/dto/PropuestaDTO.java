...
public class PropuestaDTO {
    ...
    public String getProponente() { return proponente; }
    public void setProponente(String proponente) { this.proponente = proponente; }
    ...
    public Float getMontoEntrada() { return montoEntrada; }
    public void setMontoEntrada(Float montoEntrada) { this.montoEntrada = montoEntrada; }
    ...
    public Integer getCantColaboradores() { return cantColaboradores; }
    public void setCantColaboradores(Integer cantColaboradores) { this.cantColaboradores = cantColaboradores; }

    public java.util.List<String> getColaboradores() { return colaboradores; }
    public void setColaboradores(java.util.List<String> colaboradores) { this.colaboradores = colaboradores; }
}

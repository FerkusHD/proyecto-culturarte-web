...
<body>
    ...
    <div class="formulario">
        ...
        <input id="confirmar" name="confirmar" type="password" placeholder="confirmar" required>
     </div>
     ...
     <fieldset class="checkbox-group">
      ...
      <label>
        <input id="colaborador" type="radio" name="rol" value="colaborador" required>
        Colaborador
      </label>
      <label>
        <input id="proponente" onclick="mostrar()" type="radio" name="rol" value="proponente">
        Proponente
      </label>
    </fieldset>
    ...
    <div class="campo-extra">
     ...
     <div class="campo-extra">
        ...
        <textarea id="biografia" name="biografia" type="textarea" placeholder="biografia"></textarea>
     </div>
   ...
   <script>
   function mostrar() {
   const radio = document.getElementById('proponente');
   const extras = document.querySelectorAll('.campo-extra');

   extras.forEach(div => {
   div.style.display = radio.checked ? 'flex' : 'none';
   });
   }

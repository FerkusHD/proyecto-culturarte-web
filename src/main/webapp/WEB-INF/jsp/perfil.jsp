        ...
        <div class="col-md-4 text-center">
            ...
            <div class="card p-3">
                ...
                <div class="text-start">
                    <p class="fw-bold mb-1">Siguiendo (${perfilVisitado.seguidos.size()})</p>
                    <c:forEach var="s" items="${perfilVisitado.seguidos}" begin="0" end="4">
                        <a href="/perfil/${s.nickname}" class="badge bg-secondary text-decoration-none">${s.nickname} (${s.tipo})</a>
                    </c:forEach>
                    <c:if test="${perfilVisitado.seguidos.size() > 5}">...</c:if>
                </div>
            </div>

...
### Error 500 al cargar propuestas
- Verificar que el servicio SOAP esté corriendo
- Revisar logs del servidor
- Verificar conexión a la base de datos

### Categorías no cargan
- Verificar que el endpoint `/categorias/tree` responda correctamente
- Revisar consola del navegador para errores JavaScript
- Verificar que el servicio SOAP tenga categorías en la BD

### Imágenes no se muestran
- Verificar que la carpeta `uploads/imagenes/` exista
- Verificar permisos de escritura en la carpeta
- Revisar rutas en el código JavaScript

## 📝 Notas Adicionales

- Las imágenes se guardan en `uploads/imagenes/`
- El servicio SOAP debe estar corriendo antes que la web app
- La base de datos se inicializa automáticamente con Docker
- Los usuarios móviles solo pueden ser colaboradores
...
- Documentación Spring WS: https://spring.io/projects/spring-ws

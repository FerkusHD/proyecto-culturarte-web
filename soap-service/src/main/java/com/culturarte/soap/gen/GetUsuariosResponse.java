 ...
 *       &lt;sequence&gt;
 *         &lt;element name="usuarios" type="{http://www.culturarte.com/ws/usuarios}usuarioType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetUsuariosResponse {
    ...
    protected List<UsuarioType> usuarios;
     ...
     * 
     */
    public List<UsuarioType> getUsuarios() {
        if (usuarios == null) {
            usuarios = new ArrayList<UsuarioType>();
        }

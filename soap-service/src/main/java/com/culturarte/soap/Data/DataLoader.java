...
public class DataLoader implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                try {
                        ...
                        controlador.nuevoEstadoPropuesta("Cine en el Botánico", TipoEstado.PUBLICADA,
                                        LocalDate.of(2025, 6, 1), LocalTime.of(10, 15));
                        controlador.nuevoEstadoPropuesta("Religiosamente", TipoEstado.PUBLICADA,
                                        LocalDate.of(2025, 7, 5), LocalTime.of(11, 10));
                        controlador.nuevoEstadoPropuesta("El Pimiento Indomable", TipoEstado.PUBLICADA,
                                        LocalDate.of(2025, 7, 27), LocalTime.of(9, 45));
                        controlador.nuevoEstadoPropuesta("Pilsen Rock", TipoEstado.PUBLICADA, LocalDate.of(2025, 8, 2),
                                        LocalTime.of(16, 5));
                        controlador.nuevoEstadoPropuesta("Romeo y Julieta", TipoEstado.PUBLICADA,
                                        LocalDate.of(2025, 8, 9), LocalTime.of(14, 50));
                        controlador.nuevoEstadoPropuesta("Un día de Julio", TipoEstado.PUBLICADA,
                                        LocalDate.of(2025, 8, 14), LocalTime.of(13, 10));
                        controlador.nuevoEstadoPropuesta("El Lazarillo de Tormes", TipoEstado.PUBLICADA,
                                        LocalDate.of(2025, 8, 20), LocalTime.of(17, 20));

                        controlador.altaColaboracion(50000, LocalDate.of(2025, 5, 20), LocalTime.of(14, 30),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Cine en el Botánico", "novick");
                        controlador.registrarPago(crearPagoTarjeta(50000, LocalDate.of(2025, 5, 20),
                                        LocalTime.of(14, 30), "Edgardo Novick"), "novick", "Cine en el Botánico");

                        controlador.altaColaboracion(50000, LocalDate.of(2025, 5, 24), LocalTime.of(17, 25),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Cine en el Botánico", "robinh");
                        controlador.registrarPago(crearPagoTarjeta(50000, LocalDate.of(2025, 5, 24),
                                        LocalTime.of(17, 25), "Robin Henderson"), "robinh", "Cine en el Botánico");

                        controlador.altaColaboracion(50000, LocalDate.of(2025, 5, 30), LocalTime.of(18, 30),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Cine en el Botánico", "nicoJ");
                        controlador.registrarPago(crearPagoTarjeta(50000, LocalDate.of(2025, 5, 30),
                                        LocalTime.of(18, 30), "Nicolas Jodal"), "nicoJ", "Cine en el Botánico");

                        controlador.altaColaboracion(200000, LocalDate.of(2025, 6, 30), LocalTime.of(14, 25),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Religiosamente", "marcelot");
                        controlador.registrarPago(crearPagoTarjeta(200000, LocalDate.of(2025, 6, 30),
                                        LocalTime.of(14, 25), "Marcelo Tinelli"), "marcelot", "Religiosamente");

                        controlador.altaColaboracion(500, LocalDate.of(2025, 7, 1), LocalTime.of(18, 05),
                                        TipoRetorno.ENTRADAGRATIS, "Religiosamente", "Tiajaci");
                        controlador.registrarPago(crearPagoTarjeta(500, LocalDate.of(2025, 7, 1), LocalTime.of(18, 05),
                                        "Tia Jacinta"), "Tiajaci", "Religiosamente");

                        controlador.altaColaboracion(600, LocalDate.of(2025, 7, 7), LocalTime.of(17, 45),
                                        TipoRetorno.ENTRADAGRATIS, "Religiosamente", "Mengano");
                        controlador.registrarPago(crearPagoTarjeta(600, LocalDate.of(2025, 7, 7), LocalTime.of(17, 45),
                                        "Mengano Gomez"), "Mengano", "Religiosamente");

                        controlador.altaColaboracion(50000, LocalDate.of(2025, 7, 10), LocalTime.of(14, 35),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Religiosamente", "novick");
                        controlador.registrarPago(crearPagoTarjeta(50000, LocalDate.of(2025, 7, 10),
                                        LocalTime.of(14, 35), "Edgardo Novick"), "novick", "Religiosamente");

                        controlador.altaColaboracion(50000, LocalDate.of(2025, 7, 15), LocalTime.of(9, 45),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Religiosamente", "sergiop");
                        controlador.registrarPago(crearPagoTarjeta(50000, LocalDate.of(2025, 7, 15),
                                        LocalTime.of(9, 45), "Sergio Puglia"), "sergiop", "Religiosamente");

                        controlador.altaColaboracion(200000, LocalDate.of(2025, 8, 1), LocalTime.of(7, 40),
                                        TipoRetorno.PORCENTAJEGANANCIA, "El Pimiento Indomable", "marcelot");
                        controlador.registrarPago(crearPagoTarjeta(200000, LocalDate.of(2025, 8, 1),
                                        LocalTime.of(7, 40), "Marcelo Tinelli"), "marcelot", "El Pimiento Indomable");

                        controlador.altaColaboracion(80000, LocalDate.of(2025, 8, 3), LocalTime.of(9, 25),
                                        TipoRetorno.PORCENTAJEGANANCIA, "El Pimiento Indomable", "sergiop");
                        controlador.registrarPago(crearPagoTarjeta(80000, LocalDate.of(2025, 8, 3), LocalTime.of(9, 25),
                                        "Sergio Puglia"), "sergiop", "El Pimiento Indomable");

                        controlador.altaColaboracion(50000, LocalDate.of(2025, 8, 5), LocalTime.of(16, 50),
                                        TipoRetorno.ENTRADAGRATIS, "Pilsen Rock", "chino");
                        controlador.registrarPago(crearPagoTarjeta(50000, LocalDate.of(2025, 8, 5),
                                        LocalTime.of(16, 50), "Alvaro Recoba"), "chino", "Pilsen Rock");

                        controlador.altaColaboracion(120000, LocalDate.of(2025, 8, 10), LocalTime.of(15, 50),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Pilsen Rock", "novick");
                        controlador.registrarPago(crearPagoTarjeta(120000, LocalDate.of(2025, 8, 10),
                                        LocalTime.of(15, 50), "Edgardo Novick"), "novick", "Pilsen Rock");

                        controlador.altaColaboracion(120000, LocalDate.of(2025, 8, 15), LocalTime.of(19, 30),
                                        TipoRetorno.ENTRADAGRATIS, "Pilsen Rock", "tonyp");
                        controlador.registrarPago(crearPagoTarjeta(120000, LocalDate.of(2025, 8, 15),
                                        LocalTime.of(19, 30), "Antonio Pacheco"), "tonyp", "Pilsen Rock");

                        controlador.altaColaboracion(100000, LocalDate.of(2025, 8, 13), LocalTime.of(4, 58),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Romeo y Julieta", "sergiop");
                        controlador.registrarPago(crearPagoTarjeta(100000, LocalDate.of(2025, 8, 13),
                                        LocalTime.of(4, 58), "Sergio Puglia"), "sergiop", "Romeo y Julieta");

                        controlador.altaColaboracion(200000, LocalDate.of(2025, 8, 14), LocalTime.of(11, 25),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Romeo y Julieta", "marcelot");
                        controlador.registrarPago(crearPagoTarjeta(200000, LocalDate.of(2025, 8, 14),
                                        LocalTime.of(11, 25), "Marcelo Tinelli"), "marcelot", "Romeo y Julieta");

                        controlador.altaColaboracion(30000, LocalDate.of(2025, 8, 15), LocalTime.of(04, 48),
                                        TipoRetorno.ENTRADAGRATIS, "Un día de Julio", "tonyp");
                        controlador.registrarPago(crearPagoTarjeta(30000, LocalDate.of(2025, 8, 15),
                                        LocalTime.of(04, 48), "Antonio Pacheco"), "tonyp", "Un día de Julio");

                        controlador.altaColaboracion(150000, LocalDate.of(2025, 8, 17), LocalTime.of(15, 30),
                                        TipoRetorno.PORCENTAJEGANANCIA, "Un día de Julio", "marcelot");
                        controlador.registrarPago(crearPagoTarjeta(150000, LocalDate.of(2025, 8, 17),
                                        LocalTime.of(15, 30), "Marcelo Tinelli"), "marcelot", "Un día de Julio");

                        // Propuestas Canceladas
                        controlador.nuevoEstadoPropuesta("Cine en el Botánico", TipoEstado.CANCELADA,
                                        LocalDate.of(2025, 6, 15), LocalTime.of(14, 50));
        ...
        private DTPago crearPagoTarjeta(float monto, LocalDate fecha, LocalTime hora, String titular) {
                DTPago pago = new DTPago(monto, fecha, hora, TipoPago.TARJETA, titular);
                pago.setTipoTarjeta(TipoTarjeta.VISA);
